    ...
    <body>
        ...
        <section class="events">
          ...
          <form action="prodotto.php" method="POST">
            <div class="row">
                <div class="col col2">
                    <img src="../foto/EldenRing.jpeg" class="img" style="height: 280px; width: 500px;">
                    <p> 
                        Play Elden ring
                    </p>
                    <button type=submit name="nomeG" class="ctn" value="Elden Ring">View more</button>
                </div>
                ...
                <div class="col col2">
                    ...
                    <button type=submit name="nomeG" class="ctn" value="Final Fantasy XV">View more</button>
                </div>
            </div>
          </form>
        </section>
        ...
        <section class="game-section">
            ...
            <div class="owl-carousel custom-carousel owl-theme">
                <div class="item active" style="background-image: url(../foto/dragonball.jpeg)">
                    <div class="item-desc">
                        <h3>Dragon Ball Z Kakarot</h3>
                        <p  style="margin-bottom: 20px;">Gioco ambientato nel mondo di dragon ball nei panni di goku</p>
                        <button type=submit name="nomeG" class="ctn" value="Dragon Ball Z">View more</button>
                    </div>
                </div>
                <div class="item" style="background-image: url(../foto/witcher.jpeg);">
                    <div class="item-desc">
                        <h3>The Witcher 3</h3>
                        ...
                        <button type=submit name="nomeG" class="ctn" value="The Witcher 3">View more</button>
                    </div>
                </div>
                <div class="item" style="background-image: url(../foto/RDR2.jpeg)">
                    <div class="item-desc">
                        <h3>RDR 2</h3>
                ...
                <div class="item" style="background-image: url(../foto/3.jpg);">
                    <div class="item-desc">
                        <h3>Titans</h3>
                        <p>Titans multiplayer online battle royale game published and developed by the South Korean company Bluehole.</p>
                    </div>
                </div>
                <div class="item" style="background-image: url(../foto/Skyrim.jpeg);">
                    <div class="item-desc">
                        <h3>Skyrim</h3>
        ...
        <form action="prodotto.php" method="POST">
            <header class="header2">
                ...
                <button type=submit name="nomeG" class="ctn" value="Diablo IV">View more</button>
            </header>
            ...
            <header class="header2">
                ...
                <button type=submit name="nomeG" class="ctn" value="Assassins Creed">View more</button>
            </header>

            <header class="header2" style="height: 350px;">
                <img src="../foto/BaldursGate.jpeg" alt="FOTO3" class="terza img">
                ...
                <button type=submit name="nomeG" class="ctn" value="Baldurs Gate 3">View more</button>
            </header>
        </form>
        </section>
